	...
	public ResponseEntity<String> getMetadata(@RequestHeader(value = "x-csrf-token", required = false) String csrfToken) {
		String metadataXml = """
            ...
            <EntityType Name="A_SalesOrderCreditSimulationType" sap:label="Sales Order Credit Simulation (API)" sap:content-version="1">
                ...
                <Property Name="TotalCreditCheckStatus" Type="Edm.String" MaxLength="1" sap:display-format="UpperCase" sap:label="Credit Status" sap:quickinfo="Overall Status of Credit Checks"/>
            ...
            <EntityType Name="A_SalesOrderItemPartnerSimlnType" sap:label="Sales Order Item Partner Sim (API)" sap:content-version="1">
                <Key>
                    <PropertyRef Name="SalesOrder"/>
                ...
                <Property Name="PartnerFunctionInternalCode" Type="Edm.String" MaxLength="2" sap:display-format="UpperCase" sap:label="Partner Function" sap:creatable="false" sap:updatable="false"/>
                ...
                <Property Name="WorkAssignmentExternalID" Type="Edm.String" MaxLength="100" sap:label="Work Agreement ID"/>
            ...
            <EntityType Name="A_SalesOrderItemSimulationType" sap:label="Sales Order Item Simulation (API)" sap:content-version="1">
                <Key>
                    <PropertyRef Name="SalesOrder"/>
                    <PropertyRef Name="SalesOrderItem"/>
                </Key>
                ...
                <Property Name="HigherLevelItemUsage" Type="Edm.String" MaxLength="1" sap:display-format="UpperCase" sap:label="Usage of HL Item" sap:quickinfo="ID for higher-level item usage" sap:creatable="false" sap:updatable="false"/>
                ...
                <Property Name="RequestedQuantity" Type="Edm.Decimal" Precision="15" Scale="3" sap:unit="RequestedQuantitySAPUnit" sap:label="Requested Quantity"/>
                <Property Name="RequestedQuantityUnit" Type="Edm.String" MaxLength="3" sap:label="Requested Qty Unit" sap:quickinfo="Unit of the Requested Quantity" sap:semantics="unit-of-measure"/>
                <Property Name="RequestedQuantitySAPUnit" Type="Edm.String" MaxLength="3" sap:label="SAP Code Req. Qty" sap:quickinfo="SAP Unit Code for Requested Quantity" sap:semantics="unit-of-measure"/>
                ...
                <Property Name="OrderQuantityUnit" Type="Edm.String" MaxLength="3" sap:label="Sales Unit" sap:creatable="false" sap:updatable="false" sap:semantics="unit-of-measure"/>
                <Property Name="OrderQuantitySAPUnit" Type="Edm.String" MaxLength="3" sap:label="SAP Order Quantity" sap:quickinfo="SAP Unit Code for Order Quantity" sap:creatable="false" sap:updatable="false" sap:semantics="unit-of-measure"/>
                <Property Name="OrderQuantityISOUnit" Type="Edm.String" MaxLength="3" sap:display-format="UpperCase" sap:label="ISO Order Quantity" sap:quickinfo="ISO Unit Code for Order Quantity" sap:creatable="false" sap:updatable="false"/>
                <Property Name="ConfdDelivQtyInOrderQtyUnit" Type="Edm.Decimal" Precision="15" Scale="3" sap:unit="OrderQuantitySAPUnit" sap:label="Confirmed Quantity" sap:quickinfo="Cumulative Confirmed Quantity in Sales Unit" sap:creatable="false" sap:updatable="false"/>
                <Property Name="ItemGrossWeight" Type="Edm.Decimal" Precision="15" Scale="3" sap:unit="ItemWeightSAPUnit" sap:label="Gross Weight" sap:quickinfo="Gross Weight of the Item" sap:creatable="false" sap:updatable="false"/>
                <Property Name="ItemNetWeight" Type="Edm.Decimal" Precision="15" Scale="3" sap:unit="ItemWeightSAPUnit" sap:label="Net Weight" sap:quickinfo="Net Weight of the Item" sap:creatable="false" sap:updatable="false"/>
                ...
                <Property Name="ItemWeightSAPUnit" Type="Edm.String" MaxLength="3" sap:label="SAP Code Item Weight" sap:quickinfo="SAP Unit Code for Item Weight" sap:creatable="false" sap:updatable="false" sap:semantics="unit-of-measure"/>
                <Property Name="ItemWeightISOUnit" Type="Edm.String" MaxLength="3" sap:display-format="UpperCase" sap:label="ISO Code Item Weight" sap:quickinfo="ISO Unit Code for Item Weight" sap:creatable="false" sap:updatable="false"/>
                <Property Name="ItemVolume" Type="Edm.Decimal" Precision="15" Scale="3" sap:unit="ItemVolumeSAPUnit" sap:label="Volume" sap:quickinfo="Volume of the item" sap:creatable="false" sap:updatable="false"/>
                ...
                <Property Name="ItemVolumeSAPUnit" Type="Edm.String" MaxLength="3" sap:label="SAP Code f Item Vol." sap:quickinfo="SAP Unit Code for Item Volume" sap:creatable="false" sap:updatable="false" sap:semantics="unit-of-measure"/>
                <Property Name="ItemVolumeISOUnit" Type="Edm.String" MaxLength="3" sap:display-format="UpperCase" sap:label="ISO Unit Item Volume" sap:quickinfo="ISO Unit Code for Item Volume" sap:creatable="false" sap:updatable="false"/>
                <Property Name="OriginallyRequestedMaterial" Type="Edm.String" MaxLength="40" sap:display-format="UpperCase" sap:label="Material Entered" sap:creatable="false" sap:updatable="false"/>
                <Property Name="TransactionCurrency" Type="Edm.String" MaxLength="5" sap:display-format="UpperCase" sap:label="Document Currency" sap:quickinfo="SD Document Currency" sap:creatable="false" sap:updatable="false" sap:semantics="currency-code"/>
                <Property Name="NetAmount" Type="Edm.Decimal" Precision="16" Scale="3" sap:unit="TransactionCurrency" sap:label="Net Value" sap:quickinfo="Net Value of the Document Item in Document Currency" sap:creatable="false" sap:updatable="false"/>
                <Property Name="TaxAmount" Type="Edm.Decimal" Precision="14" Scale="3" sap:unit="TransactionCurrency" sap:label="Tax Amount" sap:quickinfo="Tax Amount in Document Currency" sap:creatable="false" sap:updatable="false"/>
                <Property Name="CostAmount" Type="Edm.Decimal" Precision="14" Scale="3" sap:unit="TransactionCurrency" sap:label="Cost" sap:quickinfo="Cost in Document Currency" sap:creatable="false" sap:updatable="false"/>
                <Property Name="Subtotal1Amount" Type="Edm.Decimal" Precision="14" Scale="3" sap:unit="TransactionCurrency" sap:label="Subtotal 1" sap:quickinfo="Subtotal 1 from Pricing Procedure for Price Element" sap:creatable="false" sap:updatable="false"/>
                <Property Name="Subtotal2Amount" Type="Edm.Decimal" Precision="14" Scale="3" sap:unit="TransactionCurrency" sap:label="Subtotal 2" sap:quickinfo="Subtotal 2 from Pricing Procedure for Price Element" sap:creatable="false" sap:updatable="false"/>
                <Property Name="Subtotal3Amount" Type="Edm.Decimal" Precision="14" Scale="3" sap:unit="TransactionCurrency" sap:label="Subtotal 3" sap:quickinfo="Subtotal 3 from Pricing Procedure for Price Element" sap:creatable="false" sap:updatable="false"/>
                <Property Name="Subtotal4Amount" Type="Edm.Decimal" Precision="14" Scale="3" sap:unit="TransactionCurrency" sap:label="Subtotal 4" sap:quickinfo="Subtotal 4 from Pricing Procedure for Price Element" sap:creatable="false" sap:updatable="false"/>
                <Property Name="Subtotal5Amount" Type="Edm.Decimal" Precision="14" Scale="3" sap:unit="TransactionCurrency" sap:label="Subtotal 5" sap:quickinfo="Subtotal 5 from Pricing Procedure for Price Element" sap:creatable="false" sap:updatable="false"/>
                <Property Name="Subtotal6Amount" Type="Edm.Decimal" Precision="14" Scale="3" sap:unit="TransactionCurrency" sap:label="Subtotal 6" sap:quickinfo="Subtotal 6 from Pricing Procedure for Price Element" sap:creatable="false" sap:updatable="false"/>
                <Property Name="MaterialSubstitutionReason" Type="Edm.String" MaxLength="4" sap:display-format="UpperCase" sap:label="Substitution Reason" sap:quickinfo="Reason for Material Substitution" sap:creatable="false" sap:updatable="false"/>
                <Property Name="MaterialGroup" Type="Edm.String" MaxLength="9" sap:display-format="UpperCase" sap:label="Material Group"/>
                <Property Name="MaterialPricingGroup" Type="Edm.String" MaxLength="2" sap:display-format="UpperCase" sap:label="Product Price Group"/>
            ...
            <EntityType Name="A_SalesOrderItmPrcgElmntSimlnType" sap:label="Sales Order Item Pricing Elmnt Sim (API)" sap:content-version="1">
                <Key>
                    <PropertyRef Name="SalesOrder"/>
                    <PropertyRef Name="SalesOrderItem"/>
                ...
                <Property Name="PriceConditionDeterminationDte" Type="Edm.DateTime" Precision="0" sap:display-format="Date" sap:label="Cndn Pricing Date" sap:quickinfo="Condition Pricing Date" sap:creatable="false" sap:updatable="false"/>
                ...
                <Property Name="ConditionCurrency" Type="Edm.String" MaxLength="5" sap:display-format="UpperCase" sap:label="Currency" sap:quickinfo="Currency Key" sap:semantics="currency-code"/>
                <Property Name="ConditionQuantity" Type="Edm.Decimal" Precision="5" Scale="0" sap:unit="ConditionQuantitySAPUnit" sap:label="Pricing Unit" sap:quickinfo="Condition Pricing Unit"/>
                ...
                <Property Name="ConditionQuantitySAPUnit" Type="Edm.String" MaxLength="3" sap:label="SAP Condition Qty" sap:quickinfo="SAP Unit Code for Condition Quantity" sap:semantics="unit-of-measure"/>
                ...
                <Property Name="ConditionIsForStatistics" Type="Edm.Boolean" sap:label="Statistical" sap:quickinfo="Condition is used for statistics" sap:creatable="false" sap:updatable="false"/>
                ...
                <Property Name="ConditionAmount" Type="Edm.Decimal" Precision="16" Scale="3" sap:unit="TransactionCurrency" sap:label="Condition Value" sap:creatable="false" sap:updatable="false"/>
                ...
                <Property Name="ConditionIsManuallyChanged" Type="Edm.Boolean" sap:label="Changed Manually" sap:quickinfo="Condition Changed Manually" sap:creatable="false" sap:updatable="false"/>
            ...
            <EntityType Name="A_SalesOrderPartnerSimulationType" sap:label="Sales Order Partner Simulation (API)" sap:content-version="1">
                <Key>
                    <PropertyRef Name="SalesOrder"/>
                    <PropertyRef Name="PartnerFunction"/>
                </Key>
            ...
            <EntityType Name="A_SalesOrderPrcgElmntSimlnType" sap:label="Sales Order Pricing Elmnt Sim (API)" sap:content-version="1">
                <Key>
                    <PropertyRef Name="SalesOrder"/>
                    <PropertyRef Name="PricingProcedureStep"/>
                    <PropertyRef Name="PricingProcedureCounter"/>
            ...
            <EntityType Name="A_SalesOrderPricingSimulationType" sap:label="Sales Order Pricing Simulation (API)" sap:content-version="1">
                <Key>
                    <PropertyRef Name="SalesOrder"/>
                </Key>
                <Property Name="SalesOrder" Type="Edm.String" Nullable="false" MaxLength="10" sap:display-format="UpperCase" sap:label="Sales Order" sap:creatable="false" sap:updatable="false"/>
                <Property Name="TotalNetAmount" Type="Edm.Decimal" Precision="16" Scale="3" sap:unit="TransactionCurrency" sap:label="Net Value" sap:quickinfo="Net Value of the Sales Document in Document Currency"/>
                <Property Name="TransactionCurrency" Type="Edm.String" MaxLength="5" sap:display-format="UpperCase" sap:label="Document Currency" sap:quickinfo="SD Document Currency" sap:creatable="false" sap:updatable="false" sap:semantics="currency-code"/>
            ...
            <EntityType Name="A_SalesOrderScheduleLineSimlnType" sap:label="Sales Order Schedule Line Sim (API)" sap:content-version="1">
                <Key>
                    <PropertyRef Name="SalesOrder"/>
                    <PropertyRef Name="SalesOrderItem"/>
                ...
                <Property Name="OrderQuantitySAPUnit" Type="Edm.String" MaxLength="3" sap:label="SAP Order Quantity" sap:quickinfo="SAP Unit Code for Order Quantity" sap:semantics="unit-of-measure"/>
                ...
                <Property Name="ScheduleLineOrderQuantity" Type="Edm.Decimal" Precision="13" Scale="3" sap:unit="OrderQuantitySAPUnit" sap:label="Order Quantity" sap:quickinfo="Order Quantity in Sales Units"/>
                <Property Name="ConfdOrderQtyByMatlAvailCheck" Type="Edm.Decimal" Precision="13" Scale="3" sap:unit="OrderQuantitySAPUnit" sap:label="Confirmed Quantity"/>
                <Property Name="OpenConfdDelivQtyInOrdQtyUnit" Type="Edm.Decimal" Precision="13" Scale="3" sap:unit="OrderQuantitySAPUnit" sap:label="Open Quantity" sap:quickinfo="Open Confirmed Delivery Quantity"/>
                <Property Name="CorrectedQtyInOrderQtyUnit" Type="Edm.Decimal" Precision="13" Scale="3" sap:unit="OrderQuantitySAPUnit" sap:label="Corr.qty" sap:quickinfo="Corrected quantity in sales unit"/>
            ...
            <EntityType Name="A_SalesOrderSimulationType" sap:label="Sales Order Simulation" sap:content-version="1">
                <Key>
                    <PropertyRef Name="SalesOrder"/>
                </Key>
                ...
                <Property Name="CustomerPurchaseOrderDate" Type="Edm.DateTime" Precision="0" sap:display-format="Date" sap:label="Customer Reference Date"/>
                ...
                <Property Name="TaxDepartureCountry" Type="Edm.String" MaxLength="3" sap:display-format="UpperCase" sap:label="Tax Departure Country/Region"/>
                <Property Name="VATRegistrationCountry" Type="Edm.String" MaxLength="3" sap:display-format="UpperCase" sap:label="Tax Destination Country/Region"/>
                ...
                <Property Name="PricingDate" Type="Edm.DateTime" Precision="0" sap:display-format="Date" sap:label="Pricing Date" sap:quickinfo="Date for Pricing and Exchange Rate"/>
                <Property Name="SDPricingProcedure" Type="Edm.String" MaxLength="6" sap:display-format="UpperCase" sap:label="Pricing Procedure" sap:quickinfo="Pricing Procedure in Pricing" sap:creatable="false" sap:updatable="false"/>
                ...
                <Property Name="CompleteDeliveryIsDefined" Type="Edm.Boolean" sap:label="Complete Delivery" sap:quickinfo="Complete Delivery Defined for Each Sales Order"/>
                <Property Name="ShippingType" Type="Edm.String" MaxLength="2" sap:display-format="UpperCase" sap:label="Shipping Type"/>
                <Property Name="IncotermsClassification" Type="Edm.String" MaxLength="3" sap:display-format="UpperCase" sap:label="Incoterms" sap:quickinfo="Incoterms (Part 1)"/>
                <Property Name="IncotermsTransferLocation" Type="Edm.String" MaxLength="28" sap:label="Incoterms (Part 2)"/>
                <Property Name="IncotermsLocation1" Type="Edm.String" MaxLength="70" sap:label="Incoterms Location 1"/>
            ...
            <EntityType Name="A_SlsOrdSimlnValAddedSrvcType" sap:label="Value Added Service for SO Simulation" sap:content-version="1">
                <Key>
                ...
                <Property Name="ValueAddedServiceType" Type="Edm.String" Nullable="false" MaxLength="2" sap:display-format="NonNegative" sap:label="VAS Service Types"/>
                <Property Name="ValueAddedSubServiceType" Type="Edm.String" Nullable="false" MaxLength="5" sap:display-format="UpperCase" sap:label="VAS Sub Services"/>
                <Property Name="SalesOrder" Type="Edm.String" Nullable="false" MaxLength="10" sap:display-format="UpperCase" sap:label="Reference Document" sap:quickinfo="Document Number of Reference Document"/>
                <Property Name="SalesOrderItem" Type="Edm.String" Nullable="false" MaxLength="6" sap:display-format="NonNegative" sap:label="Reference Item" sap:quickinfo="Item Number of the Reference Item"/>
                <Property Name="ValAddedSrvcTransactionNumber" Type="Edm.String" MaxLength="10" sap:display-format="UpperCase" sap:label="Transaction Number" sap:creatable="false" sap:updatable="false"/>
                <Property Name="ValAddedSrvcItemGroup" Type="Edm.String" MaxLength="5" sap:display-format="NonNegative" sap:label="Item Group" sap:creatable="false" sap:updatable="false"/>
                <Property Name="ValAddedSrvcItemNumber" Type="Edm.String" MaxLength="5" sap:display-format="NonNegative" sap:label="Item Number" sap:creatable="false" sap:updatable="false"/>
                <Property Name="ValueAddedServiceProduct" Type="Edm.String" MaxLength="40" sap:display-format="UpperCase" sap:label="Material Number" sap:quickinfo="VAS Material Number"/>
                <Property Name="ValAddedSrvcHasToBeOrdered" Type="Edm.Boolean" sap:label="Req Relevance" sap:quickinfo="Requirement Relevancy Flag for VAS Material"/>
                <Property Name="ValAddedSrvcIncrement" Type="Edm.String" MaxLength="4" sap:display-format="NonNegative" sap:label="Increment" sap:quickinfo="VAS Increment"/>
                <Property Name="ValueAddedServiceChargeCode" Type="Edm.String" MaxLength="3" sap:display-format="UpperCase" sap:label="VAS Charge Code" sap:quickinfo="VAS Charge Codes"/>
                <Property Name="ValAddedSrvcIsCreatedManually" Type="Edm.String" MaxLength="1" sap:display-format="UpperCase" sap:label="Manual Entry Ind." sap:quickinfo="Manual Entry Indicator" sap:creatable="false" sap:updatable="false"/>
                <Property Name="ValAddedSrvcItemNumberInSD" Type="Edm.String" MaxLength="6" sap:display-format="NonNegative" sap:label="VAS Item Number" sap:quickinfo="VAS Item Number in SD" sap:creatable="false" sap:updatable="false"/>
                <Property Name="ValAddedSrvcIsRlvtForProcmt" Type="Edm.Boolean" sap:label="Procurmnt Relev" sap:quickinfo="Procurement Relevant for VAS Material"/>
                <Property Name="ValueAddedServiceText1" Type="Edm.String" MaxLength="20" sap:label="Field1" sap:quickinfo="VAS Field 1 for Free Use by Customer"/>
                <Property Name="ValueAddedServiceText2" Type="Edm.String" MaxLength="20" sap:label="Field2" sap:quickinfo="VAS Field 2 for Free Use by Customer"/>
                <Property Name="ValueAddedServiceText3" Type="Edm.String" MaxLength="20" sap:label="Field3" sap:quickinfo="VAS Field 3 for Free Use by Customer"/>
                <Property Name="ValueAddedServiceLongText" Type="Edm.String" MaxLength="132" sap:sortable="false" sap:filterable="false"/>
            </EntityType>
            <Association Name="assoc_036B9A16D7EAF5FC436B5909FDAB55C7" sap:content-version="1">
            ...
            <Association Name="assoc_1397E5E95667491CB0DAB8030565236A" sap:content-version="1">
            ...
            <Association Name="assoc_53816724613E7ECBF4FB53952D6D1176" sap:content-version="1">
            ...
            <Association Name="assoc_5953784DB807BE42507A68E85149A783" sap:content-version="1">
            ...
            <Association Name="assoc_09E895DA67A75176385AC79D884760B5" sap:content-version="1">
            ...
            <Association Name="assoc_86B3631913169957CBD0C2992D08B371" sap:content-version="1">
            ...
            <Association Name="assoc_C5EED2E8FFB18945CB96D5EBA826FB83" sap:content-version="1">
            ...
            <Association Name="assoc_0B9AFD90BACEE6F01CD6F67E38FB5A5B" sap:content-version="1">
            ...
            <Association Name="assoc_3B7A5DAD1E49589629F292F5755BF495" sap:content-version="1">
            ...
            <Association Name="assoc_C8327E2027C5F32FF63661754166938B" sap:content-version="1">
            ...
            <Association Name="assoc_9F3D7582A67C0D2CE50C97F35CA6BCA5" sap:content-version="1">
            ...
            <Association Name="assoc_26634135EFCF9268914EE7F62D4B5B39" sap:content-version="1">
            ...
            <Association Name="assoc_0A661E00C02ECA9E45F715E1F13EA2C2" sap:content-version="1">
            ...
            <Association Name="assoc_5F2ADB264BF23A2504FDED7DD5AE3EEB" sap:content-version="1">
            ...
            <Association Name="assoc_D80C4CA7BCFA91A324AFCB9CE1C08212" sap:content-version="1">
            ...
            <Association Name="assoc_DE0AC028DA6E05F98B684C56601E6E40" sap:content-version="1">
            ...
            <Association Name="assoc_2D7F894DE8E30E5BEDD13142E51B8F5F" sap:content-version="1">
            ...
            <Association Name="assoc_E0FE476A735DC637844E2A44BD30085C" sap:content-version="1">
            ...
            <Association Name="assoc_B7946EDD467E2BD88C87A57E636DB365" sap:content-version="1">
            ...
            <EntityContainer Name="API_SALES_ORDER_SIMULATION_SRV_Entities" m:IsDefaultEntityContainer="true" sap:message-scope-supported="true" sap:supported-formats="atom json xlsx">
                <EntitySet Name="A_SalesOrderCreditSimulation" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SalesOrderCreditSimulationType" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1"/>
                <EntitySet Name="A_SalesOrderItemPartnerSimln" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SalesOrderItemPartnerSimlnType" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1"/>
                <EntitySet Name="A_SalesOrderItemSimulation" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SalesOrderItemSimulationType" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1"/>
                <EntitySet Name="A_SalesOrderItmPrcgElmntSimln" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SalesOrderItmPrcgElmntSimlnType" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1"/>
                <EntitySet Name="A_SalesOrderPartnerSimulation" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SalesOrderPartnerSimulationType" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1"/>
                <EntitySet Name="A_SalesOrderPrcgElmntSimln" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SalesOrderPrcgElmntSimlnType" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1"/>
                <EntitySet Name="A_SalesOrderPricingSimulation" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SalesOrderPricingSimulationType" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1"/>
                <EntitySet Name="A_SalesOrderScheduleLineSimln" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SalesOrderScheduleLineSimlnType" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1"/>
                <EntitySet Name="A_SalesOrderSimulation" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SalesOrderSimulationType" sap:updatable="false" sap:deletable="false" sap:content-version="1"/>
                <EntitySet Name="A_SlsOrdSimlnValAddedSrvc" EntityType="API_SALES_ORDER_SIMULATION_SRV.A_SlsOrdSimlnValAddedSrvcType" sap:content-version="1"/>
                <AssociationSet Name="assoc_5953784DB807BE42507A68E85149A783" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_5953784DB807BE42507A68E85149A783" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_036B9A16D7EAF5FC436B5909FDAB55C7" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_036B9A16D7EAF5FC436B5909FDAB55C7" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_5F2ADB264BF23A2504FDED7DD5AE3EEB" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_5F2ADB264BF23A2504FDED7DD5AE3EEB" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_2D7F894DE8E30E5BEDD13142E51B8F5F" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_2D7F894DE8E30E5BEDD13142E51B8F5F" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_3B7A5DAD1E49589629F292F5755BF495" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_3B7A5DAD1E49589629F292F5755BF495" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_C5EED2E8FFB18945CB96D5EBA826FB83" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_C5EED2E8FFB18945CB96D5EBA826FB83" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_9F3D7582A67C0D2CE50C97F35CA6BCA5" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_9F3D7582A67C0D2CE50C97F35CA6BCA5" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_B7946EDD467E2BD88C87A57E636DB365" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_B7946EDD467E2BD88C87A57E636DB365" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_DE0AC028DA6E05F98B684C56601E6E40" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_DE0AC028DA6E05F98B684C56601E6E40" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_1397E5E95667491CB0DAB8030565236A" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_1397E5E95667491CB0DAB8030565236A" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_0B9AFD90BACEE6F01CD6F67E38FB5A5B" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_0B9AFD90BACEE6F01CD6F67E38FB5A5B" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_09E895DA67A75176385AC79D884760B5" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_09E895DA67A75176385AC79D884760B5" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_E0FE476A735DC637844E2A44BD30085C" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_E0FE476A735DC637844E2A44BD30085C" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_D80C4CA7BCFA91A324AFCB9CE1C08212" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_D80C4CA7BCFA91A324AFCB9CE1C08212" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_C8327E2027C5F32FF63661754166938B" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_C8327E2027C5F32FF63661754166938B" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_0A661E00C02ECA9E45F715E1F13EA2C2" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_0A661E00C02ECA9E45F715E1F13EA2C2" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_26634135EFCF9268914EE7F62D4B5B39" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_26634135EFCF9268914EE7F62D4B5B39" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_86B3631913169957CBD0C2992D08B371" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_86B3631913169957CBD0C2992D08B371" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
                ...
                <AssociationSet Name="assoc_53816724613E7ECBF4FB53952D6D1176" Association="API_SALES_ORDER_SIMULATION_SRV.assoc_53816724613E7ECBF4FB53952D6D1176" sap:creatable="false" sap:updatable="false" sap:deletable="false" sap:content-version="1">
